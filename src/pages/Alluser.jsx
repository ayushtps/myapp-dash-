      ...
      <div className="dash-chart-container">
        ...
        <div className="right-btn">
          <div className="add-user-btn">
            <button onClick={() => setisModalOpen(!isModalOpen)}><span>Add New User</span></button>
          </div>
        </div>
        ...
        >
          ...
          <div className="modal-form">
            <Form>
              <Form.Item>
                <Input placeholder="First Name" name='firstName' value={registerForm.firstName} onChange={handleChange} />
              </Form.Item>
              <Form.Item>
                <Input placeholder="Last Name" name='lastName' value={registerForm.lastName} onChange={handleChange} />
              </Form.Item>
              <Form.Item>
              ...
              <Form.Item>
                <Input placeholder="Confirm Password" name='confirmPassword' type='password' value={registerForm.confirmPassword} onChange={handleChange} />
              </Form.Item>
              <Form.Item>
                <Input placeholder="Profile Url" name='profileImage' value={registerForm.profileImage} onChange={handleChange} />
              </Form.Item>

              <Form.Item>
                <div className="footer-form-btn">
                  <Button type="primary" htmlType="submit" onClick={handalsubmit}>
                    Submit
                  </Button>
        ...
        >
          ...
          <div className="modal-form">
            <Form>
              <Form.Item>
                <Input value={registerForm.firstName} name='firstName' onChange={handleChange} />
              </Form.Item>
              <Form.Item>
                <Input value={registerForm.lastName} name='lastName' onChange={handleChange} />
              </Form.Item>
              <Form.Item>
                <Input value={registerForm.mobileNumber} name='mobileNumber' onChange={handleChange} />
              </Form.Item>
              <Form.Item>
                <Input value={registerForm.email} name='email' onChange={handleChange} disabled />
              </Form.Item>
              <Form.Item>
                <Input value={registerForm._id} name='_id' onChange={handleChange} disabled />
              </Form.Item>

              <Form.Item>
                <div className="footer-form-btn">
                  <Button type="primary" htmlType="submit" onClick={handalEditSubmit}>
                    Submit
                  </Button>
                  <Button type="primary" htmlType="submit" onClick={handleCancel}>
                    Cancel
        ...
        >
          ...
          <div className="modal-form">
            <Form>
              <Form.Item>
                <Input value={registerForm.firstName} name='firstName' disabled />
              </Form.Item>
              <Form.Item>
                <Input value={registerForm.lastName} name='lastName' disabled />
              </Form.Item>
              <Form.Item>
                <Input value={registerForm.mobileNumber} name='mobileNumber' disabled />
              </Form.Item>
              <Form.Item>
